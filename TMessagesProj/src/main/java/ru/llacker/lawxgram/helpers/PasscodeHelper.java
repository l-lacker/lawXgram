...
public class PasscodeHelper {
    private static final String PREFS_NAME = "lawxpasscode";
    private static final String LEGACY_PREFS_NAME = "nekopasscode";
    ...
    public static void clearAll() {
        preferences.edit()
                .clear()
                .putBoolean(PreferencesMigrationHelper.getMigrationMarkerKey(PREFS_NAME), true)
                .apply();
    }
}
