...
public class WebAppHelper {
    ...
    public static void processBotEvents(BotWebViewContainer.Delegate delegate, String eventData, Consumer<String> eventCallback) {
        ...
        if (event.equals("get_config")) {
            ...
            data.addProperty("trust", !LawxConfig.shouldNOTTrustMe);
            ...
            switch (data.get("key").getAsString()) {
                case "trust":
                    LawxConfig.shouldNOTTrustMe = !data.get("value").getAsBoolean();
                    editor.putBoolean("shouldNOTTrustMe", LawxConfig.shouldNOTTrustMe);
                    break;
            }
            editor.apply();
