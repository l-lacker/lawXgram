package ru.llacker.lawxgram.helpers.remote;
...
public abstract class BaseRemoteHelper {
    private static final String PREFS_NAME = "lawxremoteconfig";
    private static final String LEGACY_PREFS_NAME = "nekoremoteconfig";

    protected static final SharedPreferences preferences = PreferencesMigrationHelper.getSharedPreferences(ApplicationLoader.applicationContext, PREFS_NAME, LEGACY_PREFS_NAME);
