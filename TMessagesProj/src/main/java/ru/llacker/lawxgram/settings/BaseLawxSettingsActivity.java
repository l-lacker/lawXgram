...
public abstract class BaseLawxSettingsActivity extends BaseFragment {
    ...
    public BaseLawxSettingsActivity() {
        this(null);
    }

    public BaseLawxSettingsActivity(Bundle args) {
        super(args);
    ...
    public View createView(Context context) {
        ...
        listView = new UniversalRecyclerView(this, this::fillItems, this::onItemClick, (item, view, position, x, y) -> {
            ...
            var slug = item.slug;
            var key = getKey();
            if (!TextUtils.isEmpty(key) && item.enabled && !TextUtils.isEmpty(slug)) {
                ItemOptions.makeOptions(this, view)
                        .setScrimViewBackground(listView.getClipBackground(view))
                        .add(R.drawable.msg_copy, LocaleController.getString(R.string.CopyLink), () -> {
                            if ("copyReportId".equals(slug)) {
                                AndroidUtilities.addToClipboard(SettingsHelper.createSettingsLink(getMessagesController().linkPrefix, "reportId", null));
                            } else if ("checkUpdate".equals(slug)) {
                                AndroidUtilities.addToClipboard(SettingsHelper.createSettingsLink(getMessagesController().linkPrefix, "update", null));
                            } else {
                                AndroidUtilities.addToClipboard(SettingsHelper.createSettingsLink(getMessagesController().linkPrefix, key, slug));
                            }
            ...
            public Integer getSelectorColor(int position) {
                return BaseLawxSettingsActivity.this.getSelectorColor(position);
            }
        };
