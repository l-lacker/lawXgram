...
public class LawxLanguagesSelectActivity extends BaseLawxSettingsActivity {
    ...
    private final ArrayList<LawxLanguagesSelectActivity.LocaleInfo> allLanguages = new ArrayList<>();
    private final ArrayList<LawxLanguagesSelectActivity.LocaleInfo> sortedLanguages = new ArrayList<>();
    private final ArrayList<LawxLanguagesSelectActivity.LocaleInfo> searchResult = new ArrayList<>();
    ...
    public LawxLanguagesSelectActivity(int type) {
    ...
    private void search(String text) {
        ...
        Utilities.searchQueue.postRunnable(searchRunnable = () -> {
            var results = new ArrayList<LawxLanguagesSelectActivity.LocaleInfo>();
        ...
        Collections.sort(sortedLanguages, (o1, o2) -> {
            if (currentType == TYPE_TARGET) {
                if (o1.langCode.equals("app")) {
                    ...
                    return 1;
                } else if (LawxConfig.translationTarget.equals(o1.langCode)) {
                    return -1;
                } else if (LawxConfig.translationTarget.equals(o2.langCode)) {
                    return 1;
                }
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        for (var locale : (searchWas ? searchResult : sortedLanguages)) {
            ...
            item.checked = currentType == TYPE_RESTRICTED ? restrictedLanguages.contains(locale.langCode) : LawxConfig.translationTarget.equals(locale.langCode);
            items.add(item);
        }
        items.add(UItem.asShadow(null));
    }
    ...
    protected void onItemClick(UItem item, View view, int position, float x, float y) {
        ...
        if (localeInfo != null) {
            if (currentType == TYPE_RESTRICTED) {
                ...
                LawxConfig.setTranslationTarget(localeInfo.langCode);
                finishFragment();
            }
        }
    }
