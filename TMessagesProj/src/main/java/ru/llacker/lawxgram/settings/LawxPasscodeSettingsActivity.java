...
public class LawxPasscodeSettingsActivity extends BaseLawxSettingsActivity {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        var link = SettingsHelper.createSettingsLink("t.me", PasscodeHelper.getSettingsKey(), null);
        ...
        stringBuilder.setSpan(new URLSpanNoUnderline(null) {
            ...
            public void onClick(@NonNull View view) {
                ...
                BulletinFactory.of(LawxPasscodeSettingsActivity.this).createCopyLinkBulletin().show();
            }
    ...
    protected String getActionBarTitle() {
        return LocaleController.getString(R.string.PasscodeLawx);
    }
