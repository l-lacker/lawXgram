    ...
    private ActionMode.Callback createActionCallback() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, android.R.id.textAssist, 2, LocaleController.getString(R.string.TranslateMessage));
            ...
            public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
                ...
                MenuItem translateItem = menu.findItem(android.R.id.textAssist);
                if (translateItem != null) {
                    translateItem.setVisible(canCopy());
                }
            ...
            private void updateTranslateButton(Menu menu) {
                ...
                translateItem.setVisible(!LanguageDetector.hasSupport() || translateFromLanguage != null && !Translator.isLanguageRestricted(translateFromLanguage));
            }
