...
import ru.llacker.lawxgram.forward.ForwardDrawable;
...
public class SearchViewPager extends ViewPagerFixed implements FilteredSearchView.UiCallback, NotificationCenter.NotificationCenterDelegate, IBlur3Capture {
    ...
    private void showActionMode(boolean show) {
        ...
        if (show) {
            ...
            forwardNoQuoteItem.setVisibility(LawxConfig.showNoQuoteForward ? View.VISIBLE : View.GONE);
